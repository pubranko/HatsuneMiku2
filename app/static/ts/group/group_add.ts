...
export const group_add = (insertion_position:string): void => {
    ...
    div_tag.classList.add('p-operation_menu__postion','u-margin--t-150');
    ...
    let lists = [       //liタグの内容を配列・連想配列で生成
        ...
        { 'class_name': 'p-operation_menu__li', 'onclick': 'grouping_conditons_change("'+search_group_id+'")','menu': 'AND/OR切り替え' },
